...
namespace Web.ViewModels
{
    public class FilterViewModel
    {
        ...
        public FilterViewModel(IEnumerable<Media> entities,List<string> year, LinkedList<Genres> genre, LinkedList<Country> country, List<string> type, int currentPage)
        {
